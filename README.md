...
The Student Management System is a web-based application that helps colleges manage student records, attendance, marks, assignments, timetables, and analytics efficiently. Supports Admin, Faculty, and Student roles with secure login, role-based access, and real-time academic performance tracking.
...
- See department timetable
- Submit assignments and track pending / submitted status
- Download HTML report card
